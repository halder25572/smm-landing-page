import { ShieldCheck, Users2, TrendingUp, Award } from "lucide-react";
import { Advantage } from "@/types/common";
...
export const ADVANTAGES: Advantage[] = [
  ...
  },
  {
    ...
    description:
      "Imagine gaining 5,000 followers overnight. That looks suspicious. Algorithms notice. They flag your account. We spread delivery over time. 5,000 followers arrive over 2-4 days, not 2 hours. That makes growth look natural.",
  },
  {
    id: "track-record",
    icon: Award,
